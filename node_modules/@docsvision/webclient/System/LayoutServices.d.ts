...
export declare const $ExtendedDataSourceInfos: FieldSpec<$ExtendedDataSourceInfos, GenModels.ExtendedDataSourceInfoModel[]>;
...
export declare const $RowId: FieldSpec<$RowId, string>;
