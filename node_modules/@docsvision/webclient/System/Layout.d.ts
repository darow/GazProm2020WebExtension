...
export declare class LayoutParams extends PanelParams implements ILayoutParams {
    ...
    /**
     *  Владелец разметки.
     *  @deprecated Используйте свойство контрола разметка - parentLayout
     */
    owner?: Layout;
    /** Дочерние разметки. */
    childLayouts?: Layout[];
...
export declare class Layout extends Panel<LayoutParams, LayoutState> implements ILayout {
    protected lastSaveProcess: JQueryDeferred<any>;
    ...
    readonly layoutContainer: LayoutContainer<any>;
    ...
    /**
     * @deprecated Используйте свойство parentLayout
     */
