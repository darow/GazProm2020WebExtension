...
export interface IFileDownload {
     ...
     */
    saveAs(url: string, fileName: string): JQueryDeferred<Blob>;
}
/** Сервис для корректного инициирования скачивания файла из скриптов. */
...
import("C:/WebClient/Bin/TypeScriptDefinitions/@docsvision/System/Core/Utils/Common/GetFieldName").FieldSpec<$FileDownload, IFileDownload>;
